...
# приём оргтехники на склад и передачу в определённое подразделение компании. Для хранения данных о
# наименовании и количестве единиц оргтехники, а также других данных, можно использовать любую подходящую
...
if __name__ == '__main__':
    warehouse = Warehouse()
    warehouse.add(Printer("Epson", "XP-400"))
    warehouse.add(Scanner("OKI", "5367-AD"))
    warehouse.add(Xerox("Xerox", "F123"))
    print(warehouse)
    ...
    print("Передача 1 устройства")
    warehouse.transfer(last_idx, 'Юридический отдел')
    warehouse.transfer(last_idx, 'Отдел маркетинга')
